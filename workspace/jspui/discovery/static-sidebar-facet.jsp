...
%>
	...
	<div id="facets" class="facetsBox row panel">
		...
		<div id="facet_<%= f %>" class="facet col-md-<%= discovery_facet_cols %>">
			<div class="panel-primary" style="padding: 10px 10px 10px 10px;">
				<div class="panel-heading facet-panel" data-toggle="collapse" data-target="#collapsed_<%= f %>" >
				...
				<ul class="list-group collapse" id="collapsed_<%= f %>"><%
					int idx = 1;
    ...
    $(document).ready(function()
    {
        ...
        $(".facet-panel").click(function(){
            ...
            if(listGroup)
            {
                ...
                {
                    $(listGroup).show(200);
                    $(listGroup).parent().find(".glyphicon").attr("class", "glyphicon glyphicon-minus pull-right");
                }
                else
                {
                    $(listGroup).hide(200);
                    $(listGroup).parent().find(".glyphicon").attr("class", "glyphicon glyphicon-plus pull-right");
                }
            }
        });
