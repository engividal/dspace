...
<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="<%= request.getContextPath() %>/documentos/resolucao_repositorio.pdf" target="_blank">Politica do Repositório</a></li>
                <li><a href="<%= request.getContextPath() %>/documentos/TermoAutorizacaoPublicaDigital.doc" target="_blank">Termo de Autorização para Publicação Digital</a></li>
                <li><a href="<%= request.getContextPath() %>/fichacatalografica.jsp">Ficha Catalográfica</a> </li>
